...
<template>
    <form @submit.prevent="add" class="flex flex-col gap-4 mt-6">
        ...
        <div class="col-span-full">
            ...
            <div class="mt-2">
                <input v-model="form.model" type="text" name="model" id="model" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6" />
            </div>
        </div>
        <div class="col-span-full">
            <label for="licence-number" class="block text-sm font-medium leading-6 text-gray-900">Nr Rejestracyjny</label>
            <div class="mt-2">
                <input v-model="form.licence_number" type="text" name="licence_number" id="licence-number" class="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6" />
            </div>
        </div>
